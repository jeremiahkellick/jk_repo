...
static JkGzipDecompressResult expected_result = {
    .name = JKSI("test.txt"),
    .comment = {0},
    .contents = JKSI("There is a yummy, yummy gummy in my tummy."),
};
...
static uint8_t gzip_bytes[] = {
    ...
    // Two blocks: the first compressed with fixed Huffman codes, and the second
    // compressed with dynamic ones
    0x4a, 0x54, 0xa8, 0x2c, 0xcd, 0xcd, 0xad, 0xd4,
    0x51, 0x00, 0x53, 0x80, 0x0a, 0xe4, 0xd0, 0x06,
    0x00, 0x00, 0x84, 0x81, 0xe0, 0x2a, 0x3f, 0x41,
    0xd7, 0x6a, 0x10, 0xa0, 0x30, 0x6c, 0x4f, 0x2a,
    0xef, 0x70, 0x40, 0x0d, 0x7d, 0x6c, 0x46, 0x0f,
